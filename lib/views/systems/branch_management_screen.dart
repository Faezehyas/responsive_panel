...
class _BranchManagementScreenState extends State<BranchManagementScreen> {
    ...
    return Column(
      ...
      children: [
        ...
        Wrap(
          ...
          children: [
            MyTextFormField(
              labelText: _localeProvider.branchName,
            ),
            MyTextFormField(
            ...
            MyDropDown(
              labelText: _localeProvider.city,
              width: 200,
            ),
            MyTextFormField(
              labelText: _localeProvider.telephone,
              width: 120,
            ),
            MyTextFormField(
              labelText: _localeProvider.branchBossName,
              width: 240,
            ),
            MyTextFormField(
              labelText: _localeProvider.address,
              maxLength: 2,
            )
          ],
        ),
  ...
  _searchForm() {
    return MyTableWidget(
      ...
      data: _emplyeeList
          .map((e) => [
                MyTableItemWidget(width: 40, title: (e.count! + 1).toString()),
                MyTableItemWidget(width: 90, title: e.employeeCode),
